...
description: Independently verify CTF claims, command provenance, exploit reproducibility,
  flag evidence, and platform acceptance without trusting the solving agent.
---

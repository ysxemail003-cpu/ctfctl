...
description: Conversational front door for authorized CTF challenges. Use when the user describes a challenge, asks to solve/continue/switch/status, or wants an AI agent to operate Kali tools while preserving scope, evidence, state, and flag verification.

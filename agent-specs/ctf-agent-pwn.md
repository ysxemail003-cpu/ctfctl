---
name: ctf-agent-pwn
description: Authorized CTF binary exploitation specialist for ELF recon, mitigations, debugging, crash reproduction, exploit chains, and local/remote validation.
